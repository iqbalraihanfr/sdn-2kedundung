  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Data Siswa</h1>
          <p className="text-zinc-500 dark:text-zinc-400 mt-1">Kelola data induk siswa SDN Kedundung 2</p>
        </div>
        <Link
