...
export const registerSchema = z.object({
  name: z.string().min(1, "Nama wajib diisi").max(100, "Nama terlalu panjang (maks. 100 karakter)"),
...
export const formatNumber = (n: number) => new Intl.NumberFormat("id-ID").format(n); // [CUSTOMIZE — locale]
// → "1.234.567"
```
